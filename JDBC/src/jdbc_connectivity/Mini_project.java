	...
	public static void main(String[] args) {
		...
		try
		{
			...
			while(rs.next())
			{
			  ...
			  // Find out Highest Percentage Students
            ...
            System.out.println("\nStudent Table in Ascending Order:");
            ...
            // Add age column
            String addAgeColumnSQL = "alter table students add column age int";
            stmt.executeUpdate(addAgeColumnSQL);
            System.out.println("age column added to students table");
         // Modify column datatype
            String modifyColumnSQL = ("alter table students modify column per decimal(5,2)");
            stmt.executeUpdate(modifyColumnSQL);
            System.out.println("colum per datatype changed to decimal");
         // Rename table
            String renameTableSQL = "rename table students to stdnt";
        // delete column
            String dropColumnSQL = "alter table stdnt drop column rollno";
       //   Delete single row
            String deleteRowSQL = "delete from stdnt where rollno = 101";
         // Delete entire table
           String dropTableSQL = "drop table stdnt";
